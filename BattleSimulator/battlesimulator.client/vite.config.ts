...
const certificateName = "battlesimulator.client";
...
export default defineConfig({
    ...
    server: {
        proxy: {
            ...
            '^/battlesimulator/UpdateStats': {
                target,
                secure: false
            },
            '^/battlesimulator/ResetBattlerSlot': {
                target,
                secure: false
            },
        },
        port: parseInt(env.DEV_SERVER_PORT || '53350'),
        https: {
